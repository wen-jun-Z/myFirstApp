...
class Explorer:
    ...
    def query(
        ...
        Example:
            ...
            v9New = Explorer()
            v9New.create_embeddings_table()
            similar = v9New.query(img='https://ultralytics.com/images/zidane.jpg')
            ```
        """
    ...
    def plot_sql_query(self, query: str, labels: bool = True) -> Image.Image:
        ...
        Example:
            ...
            v9New.create_embeddings_table()
            query = "SELECT * FROM 'table' WHERE labels LIKE '%person%'"
            result = v9New.plot_sql_query(query)
            ```
        """
    ...
    def get_similar(
        ...
        Example:
            ...
            v9New = Explorer()
            v9New.create_embeddings_table()
            similar = v9New.get_similar(img='https://ultralytics.com/images/zidane.jpg')
            ```
        """
        assert return_type in [
            "pandas",
    ...
    def plot_similar(
        ...
        Example:
            ...
            v9New = Explorer()
            v9New.create_embeddings_table()
            similar = v9New.plot_similar(img='https://ultralytics.com/images/zidane.jpg')
            ```
        """
    ...
    def similarity_index(self, max_dist: float = 0.2, top_k: float = None, force: bool = False) -> DataFrame:
        ...
        Example:
            ...
            v9New = Explorer()
            v9New.create_embeddings_table()
            sim_idx = v9New.similarity_index()
            ```
        """
        if self.table is None:
            raise ValueError("Table is not created. Please create the table first.")
    ...
    def plot_similarity_index(self, max_dist: float = 0.2, top_k: float = None, force: bool = False) -> Image:
        ...
        Example:
            ...
            similarity_idx_plot = v9New.plot_similarity_index()
    ...
    def ask_ai(self, query):
        ...
        Example:
            ...
            v9New = Explorer()
            v9New.create_embeddings_table()
            answer = v9New.ask_ai('Show images with 1 person and 2 dogs')
            ```
        """

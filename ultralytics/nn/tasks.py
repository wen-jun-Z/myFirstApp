...
from ultralytics.nn.DOConv import DODConv
...
from ultralytics.nn.modules.arconv import CARC
from ultralytics.nn.modules.arconv import ARConv
from ultralytics.nn.modules.ConvNeXtv2 import ConvNeXtv2
from ultralytics.nn.modules.ConvNeXtv2 import CPNConvNeXtv2
from ultralytics.nn.modules.ConvNeXtv2 import ConvNeXtV2
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
     ...
     #   ARConv
            ...
            args = [c1, c2, *args[1:]]
        #ConvNeXtV2
        elif m is ConvNeXtv2:
            c1, c2 = ch[f], args[0]
            if c2 != nc:  # if not output
                c2 = make_divisible(min(c2, max_channels) * width, 8)
            args = [c1, c2, *args[1:]]
        elif m is CPNConvNeXtv2:
            c1, c2 = ch[f], args[0]
            if c2 != nc:  # if not output
                c2 = make_divisible(min(c2, max_channels) * width, 8)
            args = [c1, c2, *args[1:]]

...
def feature_visualization(x, module_type, stage, n=32, save_dir=Path("runs/detect/v9New")):
    """
    ...
    Args:
        ...
        save_dir (Path, optional): Directory to save results. Defaults to Path('runs/detect/v9New').
    """
